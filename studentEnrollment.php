    ...
    <body ng-controller="studentsCtrl" class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
									...
									<form id="myForm" name="myForm" method="post" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
													<select class="form-control form-select-sm" id="stId" ng-model="stid" ng-change="viewStudent1()">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" ng-model="getStudentById1.batch" id="batch" required>
                                                        <option value="">Select Any One</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <select class="form-control form-select-sm" ng-model="getStudentById1.promo" id="promo" required>
                                                        <option value="">Select Any One</option>
                                       ...
                                       <div class="card mb-4">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="name" ng-model="getStudentById1.name" ng type="text" placeholder="Enter your first name" required/>
                                                    <label for="name">Your name</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="parent_name" ng-model="getStudentById1.parent_name" type="text" placeholder="Enter your Parent name" required/>
										 ...
										 <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="institution" ng-model="getStudentById1.institution" type="text" placeholder="Enter your Mobile Number" required/>
                                                    <label for="institution">Institution</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="qualification" ng-model="getStudentById1.qualification" type="text" placeholder="Enter your Father Number" required/>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="student_mobile" ng-model="getStudentById1.student_mobile" type="text" minlength="10" maxlength="10" placeholder="Student Mobile" required/>
                                                    <label for="student_mobile">student_mobile</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="parent_mobile" ng-model="getStudentById1.parent_mobile" type="text" maxlength="10" placeholder="Parent Mobile" required/>
										...
										<div class="row mb-3">
										  <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="centre" ng-model="getStudentById1.centre" required>
                                                        <option value="">Select Any One</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="dob" ng-model="getStudentById1.dob" ng-value="getStudentById1.dob" name="dob" type="date" required/>
										...
										<div class="row mb-3">
											<div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="Email" ng-model="getStudentById1.email" name="email" type="text" 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
													<select class="form-control form-select-sm" id="source" ng-model="getStudentById1.source" required>
                                                        <option value="">Select Any One</option>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="course" ng-model="getStudentById1.course" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="program" ng-model="getStudentById1.program" required>
                                                        <option value="">Select Any One</option>
										...
										<div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="gender" name="gender" ng-model="getStudentById1.gender" required>
                                                        <option value="">Select Any One</option>
                                            ...
                                            <div class="col-md-6">
												<div class="form-floating mb-3 mb-md-0">
													<select class="form-control form-select-sm" name="prefered_country" id="prefered_country" ng-model="getStudentById1.prefered_country" required>
														<option value="">Select Any One</option>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="counsellor_id" ng-model="getStudentById1.counsellor_id" type="text" placeholder="Which Course Applying for" required/>
                                                    <label for="counsellor_id">Counsellor ID</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="counsellor_name" ng-model="getStudentById1.counsellor_name" type="text" placeholder="What Is your Qualification" required/>
										...
										<div class="row mb-3">
                                          <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="address" ng-model="getStudentById1.address" style="height: 100px" required></textarea>
													<label for="course">Address</label> 
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="remarks" ng-model="getStudentById1.remarks" style="height: 100px"></textarea>
				...
				<form class="form-horizontal well" action="studentbulkupload.php" method="post" name="upload_excel" enctype="multipart/form-data">
				<div class="col-xl-6">
				<div class="card mb-4">
                                    <div class="card-header bg-primary text-white">
                                        <i class="fas fa-chart-bar me-1"></i>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3"><a class="btn btn-success" href="studentexport.php">Download Sample Excel File</a></div>
