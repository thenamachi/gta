            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-4">Video Gallery Page</h1>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body blacktext"><!-- Place Holder for Add Student-->  <form>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                   ...
                                                   <label for="inputFirstName" class="blacktext">Video Title</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Video Description</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">You Tube Video URL</label>
                                                </div>
                                            </div>
                                       </div>
