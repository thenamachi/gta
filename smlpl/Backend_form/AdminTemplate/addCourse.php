            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-4">Add Course</h1>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="courseName" type="text" placeholder="Enter your first name" />
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="feeamount" type="text"  />
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <div class="mt-2 mb-0">
                                                        <div class="d-grid"><a class="btn btn-primary btn-block" href="#">Save Course</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
