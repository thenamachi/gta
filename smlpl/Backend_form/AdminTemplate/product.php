            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-4">Product Page</h1>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                        ...
                                        <div class="row mb-3">
                                                ...
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-select-sm" id="course" >
                                                        ...
                                                        <option>Textile Chemicals</option>
														<option>Leather Chemicals</option>
														<option>Agro</option>
														<option>Construction</option>
														<option>Detergent</option>
														<option>Paint & Printing Inks</option>
														<option>Paper</option>
														<option>Rubber</option>
														<option>Filaments</option>
														<option>Wopper</option>
														<option>Unique Products</option>
                                                     
                                                      </select>
                                                      <label for="course">Product Segment</label> 
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                   ...
                                                   <label for="inputFirstName" class="blacktext">Type Product Name</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Type Sub Product Name</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Type Description</label>
                                                </div>
                                            </div>
                                       </div>
									     ...
									     <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Type Salient Features</label>
                                                </div>
                                            </div>
                                       </div>
									     ...
									     <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Type Application</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <textarea row="10" class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name"></textarea>
                                                   <label for="inputFirstName" class="blacktext">Type Key words</label>
                                                </div>
                                            </div>
                                       </div>
