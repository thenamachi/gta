            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-4">R&D Page</h1>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header bg-primary text-white">
                                        <i class="fas fa-chart-area me-1"></i>
                                      Add R&D Page Content
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                   ...
                                                   <label for="inputFirstName" class="blacktext">Title</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Content</label>
                                                </div>
                                            </div>
                                       </div>
