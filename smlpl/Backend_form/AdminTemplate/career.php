            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-4">Career Page</h1>
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body blacktext"><!-- Place Holder for Add Student-->  <form>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                   ...
                                                   <label for="inputFirstName" class="blacktext">Type Job Title</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Type Job Content</label>
                                                </div>
                                            </div>
                                       </div>
									     ...
									     <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Type Role & Responsibility</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Contact Person</label>
                                                </div>
                                            </div>
                                       </div>
									   	...
									   	<div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Mobile no</label>
                                                </div>
                                            </div>
                                       </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control blacktext" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                   <label for="inputFirstName" class="blacktext">Email id</label>
                                                </div>
                                            </div>
                                       </div>
