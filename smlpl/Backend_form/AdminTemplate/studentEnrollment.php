                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><!-- Place Holder for Add Student-->  <form>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label for="exampleDataList" class="form-label">Search By Name / email / Mobile Number</label>
                                                <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Type to search...">
                                                <datalist id="datalistOptions">
                                                  <option value="Jayakumar">
                                                  <option value="Namachivayam / 9600045612">
                                                  <option value="Namasivayam">
                                                  <option value="Namachivayam L / 9600037999">
                                                  <option value="Anjali">
                                                </datalist>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-danger">Jayakumar</td>
                                        ...
                                        <div class="mt-1 mb-0">
                                            <div class="d-grid"><a class="btn btn-primary btn-block" href="#">Add Student for Enrollment</a></div>
                                        </div>
                                    </form>
                                    </div>
                                </div>
