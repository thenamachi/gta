								...
								<div class="col-xs-12">
									<div class="page-header-wrap">
									   ...
									   <ol class="breadcrumb">
										  ...
										  <li class="active">Wax Emulsions</li>
										</ol>
									</div>
								</div>
							</div>
													...
													<div class="tab-content">
															...
															<ul class="tab-recent-post">
																<li>
																	...
																	<div class="tab-post-heading">
																		<h3>Premium filler wax emulsion</h3>
															...
															<ul class="tab-most-read">
																<li>
																	<div class="tab-post-heading">
																		...
																		<li>Excellent filling properties</li>
																		<li>Provides soft, natural waxy feel</li>
																		<li>Improves plate release and stacking</li>
																		<li>Can be used in base and top coats</li>
																	</ul>
																	</div>
																</li>
															</ul>
														...
														<div class="tab-pane fade" id="application">
															<ul class="tab-most-read">
																<li>															
																	<div class="tab-post-heading">
																		<h3>10 –30% on the total weight of film forming resin</h3>
																	</div>
																</li>
															</ul>
														</div><!-- /most read tab -->
