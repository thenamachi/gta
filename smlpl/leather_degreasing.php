													...
													<div class="tab-content">
															...
															<ul class="tab-recent-post">
																<li>
																	...
																	<div class="tab-post-heading">
																		<h3>Premium grade anionic degreasing agent</h3>
															...
															<ul class="tab-most-read">
																<li>
																	<div class="tab-post-heading">
																		...
																		<li>Excellent degreasing action.</li>
																		<li>Instantly emulsifies and removes fats and greases.</li>
																		<li>Significantly minimizes backbone patches.</li>
														...
														<div class="tab-pane fade" id="application">
															<ul class="tab-most-read">
																<li>															
																	<div class="tab-post-heading">
																		<h3>2 –6 % based on pelt weight</h3>
																	</div>
																</li>
															</ul>
														</div><!-- /most read tab -->
