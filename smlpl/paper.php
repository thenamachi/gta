								...
								<div class="col-xs-12">
									<div class="page-header-wrap">
										<div class="page-header">
									   		<h1>Paper Chemical</h1>
									   	</div>
									   <ol class="breadcrumb">
										  <li><a href="#">Paper  Product</a></li>
								...
								<div class="col-md-3 col-sm-5 col-xs-12">
									<div class="service-sidebar sidebar-wrapper">
									        ...
									        <div class="download-wrap company">
									            <a href="#">Paper Chemical Brochure <span>Download</span><i class="fa fa-download"></i></a>
									        </div> <!-- /.download-wrap -->
									        <div class="download-wrap annual">
									            <a href="#">Paper Chemical TDS <span>Download</span><i class="fa fa-download"></i></a>
									        </div> <!-- /.download-wrap -->
													...
													<div class="tab-content">
														<div class="tab-pane fade in active" id="description2">
															...
															<ul class="tab-recent-post">
																<li>
																	...
																	<div class="tab-post-heading">
																		<h3>Enzymatic bleaching agent for pulp and paper industry</h3>
														...
														<div class="tab-pane fade" id="salient-features2">
															<ul class="tab-most-read">
																<li>
																	<div class="tab-post-heading">
																		<ul class="check-circle">
																		<li>Increase in the brightness of final bleached pulp by 1.5 – 2.0 units</li>
																		<li>Savings of 15-20% in bleaching chemicals</li>
																		<li>By achieving considerable saving in chlorine dioxide, it is also possible to increase the throughput, in case of mills with limitation in chlorine dioxide generation</li>
																	</ul>
																	</div>
																</li>
															</ul>
														...
														<div class="tab-pane fade" id="application2">
															<ul class="tab-most-read">
																<li>															
																	<div class="tab-post-heading">
																		<h3>Turbocell® BB is a world class enzyme formulation for application in pulp and paper industry for enzymatic bleaching.</h3>
