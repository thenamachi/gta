							...
							<div class="row">
								<div class="col-sm-5">
									<div class="team-thumb">
										<img class="img-responsive" src="img/team/introthumb.jpg" alt="team thumb">
									</div>
								</div><!--/.col-->
								<div class="col-sm-7">
									<div class="team-intro-content">
										<h2>Our focus is not on what we do but how we do</h2>
										<p>Enthusiastically simplify cost effective imperatives and 24/7 imperatives. Enthusiastically morph high standards in total linkage vis-a-vis granular information. Proactively syndicate magnetic human capital for timely ROI. Dramatically reconceptualize robust customer service vis-a-vis timely content. Globally foster focused internal or “organic” sources after seamless interfaces.</p>

										<p>Holisticly iterate virtual strategic theme areas vis-a-vis tactical portals. Assertively leverage existing enterprise interfaces and interactive resources. Objectively predominate cost effective information after distributed outsourcing. Compellingly enable standardized total linkage before multimedia based web services. Phosfluorescently utilize collaborative services vis-a-vis synergistic schemas.</p>
									</div>
								</div><!--/.col-->
							</div><!--/.row-->
						</div><!-- /.container-->
						...
						<div class="container">
							<div class="row">
				                <div class="col-xs-12 text-center">
				                  <h2 class="section-title">Our culture and values</h2>
				                  <span class="section-sub">Shaping the way we do business <br> through our heritage</span>
				                </div>
			             	 </div>
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="team-service-testimonial">
											<h2>Fantastic service i’m exited!</h2>
											<p>Distinctively redefine cross-unit alignments without goal-oriented ideas. Authoritatively aggregate turnkey opportunities rather than future-proof e-tailers. Continually incubate granular.</p>
											<div>
												<p><strong>Nathan Powell</strong><br>
													<small>Cloud Software</small>
						...
						<div class="container">
							<div class="row">
				                <div class="col-xs-12 text-center">
				                  ...
				                  <span class="section-sub">World class opportunities for <br> high calibre talent</span>
				                </div>
			             	 </div>
			             	 ...
			             	 <div class="team-members">
			             	 	<div class="row">
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/tm1.jpg" alt="Image">
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/tm2.jpg" alt="Image">
									            <a class="member-link" href="about-member.php" title=""><i class="fa fa-link"></i></a>
									        </div>
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/tm3.jpg" alt="Image">
									            <a class="member-link" href="about-member.php" title=""><i class="fa fa-link"></i></a>
									        </div>
								...
								<div class="row">
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/tm4.jpg" alt="Image">
									            <a class="member-link" href="about-member.php" title=""><i class="fa fa-link"></i></a>
									        </div>

											<div class="member-info">
										        <h3>WALLACE JIMENEZ
										            <small>Head Of Risk Management</small>
										        </h3>
											</div>
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/tm5.jpg" alt="Image">
									            <a class="member-link" href="about-member.php" title=""><i class="fa fa-link"></i></a>
									        </div>

											<div class="member-info">
										        <h3>ERIC RICE
										            <small>Head Of Cost Management</small>
										        </h3>
											</div>
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/tm6.jpg" alt="Image">
									            <a class="member-link" href="about-member.php" title=""><i class="fa fa-link"></i></a>
									        </div>
