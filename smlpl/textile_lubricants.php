															...
															<ul class="tab-recent-post">
																<li>
																	...
																	<div class="tab-post-heading">
																		<h3>Premium grade friction reducer cum emulsifier. Ideal for dye bath lubrication of heavy GSM fabrics.</h3>
															...
															<ul class="tab-most-read">
																<li>
																	<div class="tab-post-heading">
																		...
																		</li>Excellent emulsifier with anti crease properties.</li>
																		<li>Prevents rope and chafe marks, creasing and abrasion.</li>
																		<li>Suitable for natural, synthetic fibres and their blends.</li>
																		<li>Enhances heat setting efficiency.</li>
																		<li>Improves stain removal after heat setting.</li>
																		<li>Suitable for scour-dyeing of 100% polyester.</li>
																		</ul>
																	</div>
																</li>
															</ul>
														...
														<div class="tab-pane fade" id="application">
															<ul class="tab-most-read">
																<li>															
																	<div class="tab-post-heading">
																		<ul class="check-circle">
																		<li>Turbolube AC can be applied in pre-treatment and dyeing stages. It is suitable for all types of equipment like jet and package dyeing machines and drum washing machines for garment processing.</li>
															<li>Turbolube AC can be applied for scour-dyeing of 100% polyester.</li>
																		</ul>
																	</div>
																</li>
															</ul>
													...
													<div class="tab-content">
														<div class="tab-pane fade in active" id="description3">
															...
															<ul class="tab-recent-post">
																<li>
																	...
																	<div class="tab-post-heading">
																		<h3>Versatile polymer based lubricant and crease inhibitor.</h3>
														...
														<div class="tab-pane fade" id="salient-features3">
															<ul class="tab-most-read">
																<li>
																	<div class="tab-post-heading">
																		<ul class="check-circle">
																		<li>Improves running properties and prevents chafe marks on fabrics.</li>
																		<li>Helps penetration of auxiliaries and dye stuff smoothly.</li>
																		<li>Protects the fabric surface.</li>
																		<li>Inert towards dye stuff and substrate, and acts independently.</li>
																		<li>Performs significantly when the goods to liquor ratio is low.</li>
																		<li>Completely washable in plain water.</li>
																		<li>Allows higher loading of dyeing machine and higher speed of circulation.</li>
																		<li>Non foaming.</li>
																		<li>The performance of Turbolube LP is unaffected by change in pH, water hardness or electrolytes.</li>
																	</ul>
																	</div>
																</li>
															</ul>
														...
														<div class="tab-pane fade" id="application3">
															<ul class="tab-most-read">
																<li>															
																	<div class="tab-post-heading">
																		<h3>Turbolube LP must be added during pre-treatment as well as dyeing processes, prior to the loading of fabric for best results.</h3>
