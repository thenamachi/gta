                        ...
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="service-sidebar sidebar-wrapper">
                                        ...
                                        <div class="widget">
                                            ...
                                            <ul class="service-list">
                                                ...
                                                <li class="active"><a href="moving.php" class="icon-store">Moving &amp; storage</a></li>
                                                <li><a href="shipping.php" class="icon-shipping">Shipping &amp; operations</a></li>
                                ...
                                <div class="col-md-9 col-sm-7 col-xs-12">
                                    ...
                                    <p>
                                    <img class="img-alignleft" src="img/service/movingthumb2.png" alt="image">
			        ...
			        <ul id ="offcanvasMenu" class="list-unstyled visible-xs visible-sm">
			            ...
			            <li>
			            	...
			            	<ul>
								...
								<li class="active"><a href="moving.php">Moving &amp; storage</a></li>
