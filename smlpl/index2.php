                            ...
                            <div class="item active">
                                ...
                                <!--Slide Image-->
                                    ...
                                    <div class="carousel-caption">
                                        ...
                                        <h1 class="animated bounceIn">We help in Transforming your goals to reality</h1>

                                        <p class="lead animated bounceIn">for School and college students, <br>
										Working professionals, <br>Unemployed graduates</p>
                                        <a class="btn btn-default animated bounceIn" href="#">APPLY NOW</a>
                                    </div>
                                    <!--.carousel-caption-->
                                </div>
                                <!--.container-->
			            ...
			            <div class="container">
			              ...
			              <div class="row content-row">
			              	<div class="col-sm-4">
			              		<div class="service">
				              		<div class="service-thumb-home thumb-grid">
				              			<a href="#"><img src="img/service/thumbgrid1.png" alt=""></a>
				              		</div>
			              	...
			              	<div class="col-sm-4">
			              		<div class="service">
				              		<div class="service-thumb-home thumb-grid">
				              			<a href="#"><img src="img/service/thumbgrid2.png" alt=""></a>
				              		</div>
			              	...
			              	<div class="col-sm-4">
			              		<div class="service">
				              		<div class="service-thumb-home thumb-grid">
				              			<a href="#"><img src="img/service/thumbgrid3.png" alt=""></a>
				              		</div>
								    ...
								    <div role="tabpanel" class="tab-pane active fade in" id="secure">
									    <div class="css-tab-content">
										    <div class="row">
										    	...
										    	<div class="col-md-6">
										    		<img class="img-responsive" src="img/secure.png" alt="">
										    	</div><!-- /.col-md-6 -->
										    </div><!-- /.row -->
									    </div><!-- /.css-tab-content -->
								    </div>
								    ...
								    <div role="tabpanel" class="tab-pane fade" id="fast">
									    <div class="css-tab-content">
										    <div class="row">
										    	...
										    	<div class="col-md-6">
										    		<img class="img-responsive" src="img/fast.png" alt="">
										    	</div><!-- /.col-md-6 -->
										    </div><!-- /.row -->
									    </div><!-- /.css-tab-content -->
								    </div>
								    <div role="tabpanel" class="tab-pane fade" id="reliable">
									    <div class="css-tab-content">
										    <div class="row">
										    	...
										    	<div class="col-md-6">
										    		<img class="img-responsive" src="img/reliable.png" alt="">
										    	</div><!-- /.col-md-6 -->
										    </div><!-- /.row -->
									    </div><!-- /.css-tab-content -->
								    </div>
